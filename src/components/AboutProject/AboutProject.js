...
function AboutProject() {
  return (
    <div className="project content_info" id="aboutproject">
      ...
      <div className="project__timeline">
        <p className="project__timeline_short project__timeline_backend">
          1 неделя
        </p>
        <p className="project__timeline_long project__timeline_frontend">
          4 недели
        </p>
      </div>
      <div className="project__timeline">
